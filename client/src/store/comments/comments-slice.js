...
import { addComments, addDislike, addLike, deleteComments, deleteDislike, deleteLike, loadComments } from './commetns-actions';
...
const commentsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addMatcher(isAnyOf(loadComments.pending), (state, action) => {
        state.loading = 'loading';
        state.error = null;
      })
      .addMatcher(isAnyOf(loadComments.rejected, deleteComments.rejected, addComments.rejected, addLike.rejected, deleteLike.rejected, addDislike.rejected, deleteDislike.rejected), (state, action) => {
        state.loading = 'idle';
