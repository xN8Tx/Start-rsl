...
const loadMyUser = createAsyncThunk('@@my-user/load-my-user', async (_, { extra: $api }) => {
...
const editMyUser = createAsyncThunk('@@my-user/edit-profile', async ({ id, title }, { extra: $api }) => {
...
const addExperience = createAsyncThunk('@@my-user/add-experience', async ({ id, xp }, { getState, extra: $api }) => {
...
const uploadAvatar = createAsyncThunk('@@my-user/upload-avatar', async ({ id, avatar }, { extra: $api }) => {
...
const uploadCover = createAsyncThunk('@@my-user/upload-cover', async ({ id, cover }, { extra: $api }) => {
  const formData = new FormData();
