      ...
      { loading === 'idle' && 
        <>
          <div className="auth-login__title">
            <h1>Войти на <span>startRSL</span></h1>
          </div>
          ...
          <div className="auth-login__buttons">
            <button className="auth-login__buttons_enter" onClick={() => loginHandler()}>Войти</button>
          ...
          <div className="aut-login__nav">
            <LinkMain to="/">Забыли пароль</LinkMain>
            <LinkMain to="registration">Зарегистрироваться</LinkMain>
          </div>
        </>
      }
    </>
